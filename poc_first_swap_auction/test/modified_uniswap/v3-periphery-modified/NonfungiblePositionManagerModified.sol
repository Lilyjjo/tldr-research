...
contract NonfungiblePositionManagerModified is
    INonfungiblePositionManagerModified,
    Multicall,
    ERC721Permit,
    PeripheryImmutableState,
    PoolInitializer,
    LiquidityManagementModified,
    PeripheryValidation,
    SelfPermit
{
    ...
    /// @inheritdoc INonfungiblePositionManagerModified
    function positions(
        uint256 tokenId
    )
        external
