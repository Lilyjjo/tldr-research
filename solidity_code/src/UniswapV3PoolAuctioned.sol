...
import {IUniswapV3PoolImmutables, IUniswapV3PoolState, IUniswapV3PoolActions, IUniswapV3PoolDerivedState, IUniswapV3PoolOwnerActions, IUniswapV3Pool} from "v3-core/interfaces/IUniswapV3Pool.sol";
...
import {TickBitmap} from "v3-core/libraries/TickBitmap.sol";
import {Position} from "v3-core/libraries/Position.sol";
...
contract UniswapV3PoolAuctioned is IUniswapV3Pool, NoDelegateCall {
    ...
    constructor() {
        ...
        (
            ...
            _tickSpacing,
            _auction
        ) = IUniswapV3PoolDeployerAuctioned(msg.sender).parameters();
